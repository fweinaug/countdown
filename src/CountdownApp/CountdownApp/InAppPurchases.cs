...
namespace CountdownApp
{
  public static class InAppPurchases
  {
    ...
    {
      return await PurchaseAndFulfillConsumable("CountdownApp_Donate1");
    }

    public static async Task<bool> Donation2()
    {
      return await PurchaseAndFulfillConsumable("CountdownApp_Donate2");
    }

    public static async Task<bool> Donation3()
    {
      return await PurchaseAndFulfillConsumable("CountdownApp_Donate3");
    }
